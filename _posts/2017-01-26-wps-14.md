...
# 위의 반복문에서 튜플의 첫 번째 항목이 짝수일때만 출력하도록 조건을 변경한다.
...
<ipython-input-58-c0b32ca14f47> in <module>()
----> 1 return_list1('peer', 'mango')

<ipython-input-52-a7e106403aaf> in return_list1(value, result)
      1 def return_list1(value, result=[]):
...
<ipython-input-59-87a8dc4bec04> in <module>()
----> 1 return_list1('peer', f_list = ['mango'])
...
-------------------------------------------------------------------
TypeError                         Traceback (most recent call last)
<ipython-input-164-9e41007a5a53> in <module>()
----> 1 result = return_args(1, 2, 'abc', [], k1='abc')
